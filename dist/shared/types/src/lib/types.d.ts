...
export declare enum AgentJobStatus {
    PLANNED = "PLANNED",
    RUNNING = "RUNNING",
    COMPLETED = "COMPLETED",
    FAILED = "FAILED"
...
export declare enum CanvasBlock {
...
export declare enum BrainProposalType {
...
export declare enum BrainProposalStatus {
    PENDING = "pending",
    APPROVED = "approved",
    REJECTED = "rejected",
    EXPIRED = "expired"
}
export declare enum BrainProposalPriority {
    CRITICAL = "critical",
    HIGH = "high",
    MEDIUM = "medium",
    LOW = "low"
...
export type DeliverableType = 'xlsx' | 'pdf' | 'pptx' | 'docx' | 'png' | 'jpg' | 'jpeg' | 'csv' | 'svg';
...
export declare enum ProcessRunStatus {
    IDLE = "IDLE",
    RUNNING = "RUNNING",
...
export declare enum ProcessStepResultStatus {
    PENDING = "PENDING",
    RUNNING = "RUNNING",
    COMPLETED = "COMPLETED",
    FAILED = "FAILED",
